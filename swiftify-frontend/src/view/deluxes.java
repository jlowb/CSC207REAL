...
public class deluxes extends JFrame implements ActionListener, PropertyChangeListener  {
    ...
    private void createUIComponents() {
        ...
        speakpanel = new LoadAlbumView.ImagePanel("swiftify-frontend/src/pngs/speak_now.png");
        setContentPane(speakpanel);

        a1989panel = new LoadAlbumView.ImagePanel("swiftify-frontend/src/pngs/1989.png");
