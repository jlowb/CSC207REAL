...
public class taylorver extends JFrame implements ActionListener, PropertyChangeListener  {
    ...
    private void createUIComponents() {
        ...
        redpanel = new LoadAlbumView.ImagePanel("swiftify-frontend/src/pngs/red.png");
        setContentPane(redpanel);

        fearlesspanel = new LoadAlbumView.ImagePanel("swiftify-frontend/src/pngs/fearless.png");
